...
def serializedATN():
    return [
        ...
        0,0,5,0,2,4,6,8,0,2,1,0,1,2,1,0,3,4,39,0,10,1,0,0,0,2,12,1,0,0,0,
        ...
        8,4,0,29,30,5,5,0,0,30,32,3,8,4,0,31,29,1,0,0,0,31,32,1,0,0,0,32,
        7,1,0,0,0,33,34,5,6,0,0,34,35,3,0,0,0,35,36,5,7,0,0,36,39,1,0,0,
        0,37,39,5,8,0,0,38,33,1,0,0,0,38,37,1,0,0,0,39,9,1,0,0,0,4,17,25,
        31,38
    ]
...
class CalculatorParser ( Parser ):
    ...
    class PowerExpressionContext(ParserRuleContext):
        ...
        def primaryExpression(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(CalculatorParser.PrimaryExpressionContext)
            else:
                return self.getTypedRuleContext(CalculatorParser.PrimaryExpressionContext,i)
